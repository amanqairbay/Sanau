        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemOrdered_Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(38,2)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0747c069-6463-47fa-8604-229a9e93ed8a"), "1-2 Days", "Fastest delivery time", 10m, "UPS1" },
                    { new Guid("12b13ad8-1edf-4075-afd5-bf3b5b413220"), "2-5 Days", "Get it within 5 days", 5m, "UPS2" },
                    { new Guid("bdca0a3a-2087-4861-9e77-6965fe1b0d34"), "1-2 Weeks", "Free! You get what you pay for", 0m, "FREE" },
                    { new Guid("ee00c5a6-bb2d-454b-ab4a-f28fdc9d1d9f"), "5-10 Days", "Slower but cheap", 2m, "UPS3" }
                });
